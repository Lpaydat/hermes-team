...
# or profile import on a new machine. Fixes the recurring regression where
# bundled skills (dogfood, polymarket, etc.) get re-seeded into profiles
# despite per-profile opt-out markers.
#
...
#
# Usage:
#   bash <skill_dir>/scripts/fix-bundled-skills-opt-out.sh
#   (or the copy at ~/.hermes/profiles/base/scripts/fix-bundled-skills-opt-out.sh)
#
