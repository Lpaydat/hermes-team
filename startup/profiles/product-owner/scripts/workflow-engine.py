...
def phase_qa_trigger(board, project_dir):
    ...
    if board.endswith("-b") or board.endswith("-c") or board.endswith("-d") or board.endswith("-e") or board.endswith("-f") or board.endswith("-g") or board.endswith("-h") or board.endswith("-failtest") or board.startswith("tl-gauntlet-"):
        return actions
    db = board_db_path(board)
    if not db.exists():
        return actions
